...
def get_live_input(queue_stream):
    ...
    while(True):
        ...
        t1 = time.time()
        print(t1 - t0, " audio stream recording")
        get_audio_features(queue_stream)
        #predict_emotion()
        t2 = time.time()
        #print(t2 - t1, "feature extraction audio")
