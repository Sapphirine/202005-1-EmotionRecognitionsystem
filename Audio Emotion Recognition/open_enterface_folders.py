...
def get_audio_features(source_filepath,destination_filepath,i,label):
    ...
    feature_files = ".\Data\enterface_features_encoded"
...
def get_einterface_files():
    count_unknown, i = 0,0
    av_file_directory = ".\Data\eInterface/enterface database"
    aud_folder='.\Data\Audio_clips\enterface'
    emotions = ['anger', 'disgust','fear', 'happiness', 'sadness', 'surprise']
    for (root,dirs,files) in os.walk(".\Data\eInterface/enterface database", topdown=True): 
        for file in files:
...
if __name__ == "__main__":
    ...
    #get_savee_files()
    get_einterface_files()
    #python open_enterface_folders.py
